    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if ("Administrador".equals(rol)) {
                ...
                request.getRequestDispatcher("/admin/editarRutina.jsp").forward(request, response);
            } else {
                request.getRequestDispatcher("/entrenador/editarRutina.jsp").forward(request, response);
            }
