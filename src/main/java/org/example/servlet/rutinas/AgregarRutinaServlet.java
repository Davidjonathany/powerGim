    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if ("Administrador".equals(rol)) {
                ...
                request.getRequestDispatcher("/WEB-INF/admin/agregarRutinaAdmin.jsp").forward(request, response);
                ...
                request.setAttribute("clientes", clientes);
                request.getRequestDispatcher("/WEB-INF/entrenador/agregarRutina.jsp").forward(request, response);
