...
public class RutinaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            switch (rol) {
                case "Administrador":
                    ...
                    int totalRegistros = service.contarRutinasFiltradas(
                            nombreCliente,
                            nombreEntrenador,  // Corregido: estaba 'nomeEntrenador'
                            tipoEntrenamiento
                    );
                    ...
                    jspPath = "/WEB-INF/admin/rutinasAdmin.jsp";  // Ruta actualizada
                    break;
                ...
                case "Entrenador":
                    ...
                    req.setAttribute("totalRegistros", rutinas.size());
                    jspPath = "/WEB-INF/entrenador/rutinasEntrenador.jsp";  // Ruta actualizada
                    break;

                case "Cliente":
                    rutinas = service.listarPorCliente(usuarioId);
                    req.setAttribute("totalRegistros", rutinas.size());
                    jspPath = "/WEB-INF/cliente/rutinasCliente.jsp";  // Ruta actualizada
                    break;
            ...
            req.getRequestDispatcher("/WEB-INF/error.jsp").forward(req, resp);  // Ruta actualizada
        } catch (Exception e) {
