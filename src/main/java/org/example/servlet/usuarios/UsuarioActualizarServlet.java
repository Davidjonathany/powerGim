...
public class UsuarioActualizarServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        // Validación de sesión y rol de administrador (nuevo)
        ...
        // Resto del código original exactamente igual
        ...
        if (idUsuarioStr != null && !idUsuarioStr.isEmpty()) {
            try {
                ...
                if (usuario != null) {
                    ...
                    req.getRequestDispatcher("/WEB-INF/admin/usuarioActualizar.jsp").forward(req, resp);
                } else {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Usuario usuarioActualizar = new Usuario(nombre, apellido, usuario, clave, rolUsuario, correo, telefono, cedula, direccion);
